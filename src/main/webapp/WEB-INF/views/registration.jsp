...
<body>
	...
	<div class="well lead">Rejestracja</div>
 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
					<c:choose>
						<c:when test="${edit}">
							<form:input type="text" path="pesel" id="pesel" class="form-control input-sm" disabled="true"/>
						</c:when>
						<c:otherwise>
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-lable" for="actions">Role</label>
				<div class="col-md-7">
					<form:select path="actions" items="${roles}" multiple="true" itemValue="id" itemLabel="type" class="form-control input-sm" />
					<div class="has-error">
						<form:errors path="actions" class="help-inline"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-actions floatRight">
				<c:choose>
					...
					<c:otherwise>
						<input type="submit" value="Zarejestruj" class="btn btn-primary btn-sm"/> lub <a href="<c:url value='/list' />">Anuluj</a>
					</c:otherwise>
				</c:choose>
			</div>
		</div>
